...
interface AgentItem { id: number; name: string; description: string | null; category: string; icon_name: string | null; icon_color_from: string | null; icon_color_to: string | null; model_config_id: number | null; model_config: ModelItem | null; welcome_message: string | null; suggested_questions: string[] | null; prompt_variables: { name: string; label: string; required: boolean; default: string }[] | null; system_prompt: string | null; temperature: number; max_tokens: number; top_p: number; frequency_penalty: number; presence_penalty: number; memory_window: number; is_enabled: boolean; is_published: boolean }
